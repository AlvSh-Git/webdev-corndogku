...
<div class="bg-white px-8 py-10 w-full"
    ...
    <div class="flex gap-3">
        <button type="button"
                class="flex-1 flex items-center justify-center gap-2 py-2.5 text-xs font-medium text-black hover:bg-gray-50 transition-colors"
        ...
        <button type="button"
                class="flex-1 flex items-center justify-center gap-2 py-2.5 text-xs font-medium text-black hover:bg-gray-50 transition-colors"
                style="border:1px solid #D9D9D9; border-radius:5px;">
            <svg class="w-5 h-5 flex-none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
