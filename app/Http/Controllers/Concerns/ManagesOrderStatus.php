...
trait ManagesOrderStatus
{
    ...
    /**
     * Return each cancelled item's quantity to stock — to the product for
     * catalog items, or to the matching custom-component products for a custom
     * corndog (isi + varian + each sauce).
     */
