{{--
    ...
    Referensi Figma: node 320-10727
    Dikontrol jQuery di employee.blade.php
    IDs: #order-detail-drawer, #close-drawer-btn, #drawer-backdrop

    NOTE: z-index, display, dan transform sengaja pakai inline style (bukan Tailwind)
    agar tidak tergantung JIT compilation dan menghindari konflik dengan sidebar z-50.
--}}
...
<div id="order-detail-drawer"
    ...
    <div style="flex:none;display:flex;align-items:center;
        ...
        {{-- Right: X close button — large tap target (40×40) --}}
    ...
    <div style="flex:1;overflow-y:auto;padding:18px 20px 0;">
        ...
        <div style="margin-bottom:18px;">
            ...
            <div id="drawer-stepper"
                ...
                {{-- track fill — width driven by jQuery --}}
                <div id="stepper-fill"
        ...
        <div style="margin-bottom:20px;">
            ...
            {{-- Items populated dynamically by jQuery buildItemsHTML() --}}
            <div id="drawer-items"
    ...
    <div style="flex:none;padding:14px 20px 16px;
        ...
        <div style="display:flex;align-items:center;
            ...
            <span id="drawer-item-count"
                  style="font-size:12px;font-weight:600;color:#9CA3AF;">×4</span>
        </div>
