            ...
            @auth
                <a href="{{ route('wishlist') }}"
                   ...
                   title="Wishlist Saya">
                    ...
                    <span id="wishlist-badge" class="wishlist-badge absolute -top-1 -right-1 w-4 h-4 rounded-full text-[10px] font-bold flex items-center justify-center text-white bg-red-500">
