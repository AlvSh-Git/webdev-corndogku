...
<div class="relative overflow-hidden -m-4 sm:-m-6 lg:-m-8 p-4 sm:p-6 lg:p-8" style="background-color:#fffef0;min-height:calc(100vh - 4rem);">
    ...
    <div class="relative z-10 flex items-start justify-between mb-6">
        ...
        <img src="{{ asset('assets/ui/storefront.png') }}"
             onerror="this.style.display='none'"
             alt="Ilustrasi toko"
             class="hidden sm:block flex-none object-contain drop-shadow-md"
             style="width:128px;height:128px;margin-left:1rem;">
    </div>
        ...
        <div class="w-full lg:w-72 xl:w-80 flex-none">
            <div class="bg-white rounded-3xl p-6 flex flex-col gap-4"
                ...
                <div id="status-box"
                    ...
                    {{-- Store-open illustration --}}
                    <img src="{{ asset('assets/ui/store-open.png') }}"
                         onerror="this.style.display='none'"
                         alt="" id="status-illus"
                ...
                <button id="btn-tutup"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" style="width:20px;height:20px;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zM10 7a4 4 0 118 0v3H6V7z"/>
                    </svg>
                    Tutup Sekarang
                </button>
